...
export const fullpage_init = function () {
  ...
  new fullpage('#fullpage', {
    ...
    afterLoad: function(origin, destination){
      const a_table = ['main', 'slider', 'trademark', 'mat', 'support', 'history', 'sert'];
    ...
    onLeave: function(index, nextIndex, direction){
      ...
      if(direction == "up"){
        ...
        $("#fullpage .section:nth-child("+getCurrentIndex+")").addClass("up");
        $("#fullpage .section:nth-child("+getCurrentIndex+")").next().addClass("next");
        $("#fullpage .section:nth-child("+getCurrentIndex+")").prev().addClass("prev");
        ...
        // };
        $("#fullpage .section:nth-child("+getCurrentIndex+")").addClass("down");
        $("#fullpage .section:nth-child("+getCurrentIndex+")").next().addClass("next");
        $("#fullpage .section:nth-child("+getCurrentIndex+")").prev().addClass("prev");
