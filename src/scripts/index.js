...
// });
$('.filter--js').on('click', '.filter__item:not(.disabled)', function () {
  const getType = $(this).data('type');
  $('.filtersBody__item#' + getType).addClass('active');
});
$('.filter--js').on('click', '.filter__item.disabled', function () {
...
$(".config-filter__item input").click(function () {
...
$(".config-block-text").click(function () {
  $(this).removeClass('active');
